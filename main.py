...
# TEST_MODE:
# - True  : Pichle 3 trading days ke saare CE/PE signals Telegram par bhejega (Verification ke liye).
...
# ==============================================================================
# CLEANED NSE FnO WATCHLIST (Yahoo Finance Compatible)
# ==============================================================================
WATCHLIST = [
    # --- INDICES ---
    "^NSEI",  # Nifty 50
...
def main():
    ...
    for ticker in WATCHLIST:
        try:
            ...
            # --- TEST MODE vs LIVE MODE LOOKBACK ---
            if TEST_MODE:
                # Pichle 3 trading days ki candles lookback karein (Weekend proof)
                scan_df = df.tail(75)
            else:
                # Live Mode: Sirf latest 2 completed 15m candles check karein
                scan_df = df.iloc[-2:]
